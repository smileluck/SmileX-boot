package top.zsmile.mybatis.datascope.aspect;
...
import top.zsmile.mybatis.datascope.annotation.DataScope;
...
public class DataScopeAspect {
    ...
    @Pointcut("@within(top.zsmile.mybatis.datascope.annotation.DataScope) || @annotation(top.zsmile.mybatis.datascope.annotation.DataScope)")
