...
public class BlogArticleEntity extends BaseEntity implements Serializable {
     ...
     */
    @Schema(description = "语法类型，1markdown，2html", hidden = false)
     ...
     * 独立密码
     */
    @Schema(description = "独立密码", hidden = true)
     ...
     * 置顶状态，0未置顶，1已置顶
     */
    @Schema(description = "置顶状态，0未置顶，1已置顶", hidden = false)
